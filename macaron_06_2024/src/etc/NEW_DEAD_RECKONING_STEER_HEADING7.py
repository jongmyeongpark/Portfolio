...
def main():
    ...
    IMU_velocity_plot,IMU_accel_plot,IMU_heading_plot = [],[],[0,0,0]
    ...
    ################################################################################################
        ...
        IMU_heading = IMU_heading_plot[-1]
        #####################################
        ...
        if count >=DEAD_RECKONING_START:
            ...
            if count == DEAD_RECKONING_START:
                ...
                Percent_POS = 0.271 # 0.271 

            IMU_heading = IMU_heading +random.uniform(-0.1, 0.1) 
    ...
    plt.plot(count_plot[start:], IMU_heading_plot[start:-3], label='IMU_heading', color='blue')
