...
class LidarCameraCalibration:
    ...
    def process_calibration(self):
        if self.lidar_data is not None and self.camera_image is not None:
            ...
            # projected_points_left, _ = project_lidar_to_screen(self.lidar_data, self.camera_image[:, :640, :], ((-90,90,0), (0.11, 0.49, 0.25), (-16, -33.5, 0)))
            # projected_points_right, _ = project_lidar_to_screen(self.lidar_data, self.camera_image[:, 640:, :], ((-90,90,0), (-0.11, 0.51, 0.25), (-16, 29, 0)))
            
            # 본선용 카메라 각도 
            # projected_points_left, _ = project_lidar_to_screen(self.lidar_data, self.camera_image[:, :640, :], ((-90,90,0), (0.15, 0.54, 0.27), (-19.5, -34, 1.5)))
            # projected_points_right, _ = project_lidar_to_screen(self.lidar_data, self.camera_image[:, 640:, :], ((-90,90,0), (-0.15, 0.54, 0.27), (-21, 28, 1)))

            # projected_points_left, _ = project_lidar_to_screen(self.lidar_data, self.camera_image[:, :640, :], ((-90,90,0), (0.12, 0.52, 0.30), (-17.9, -30.4, -1)))
            # projected_points_right, _ = project_lidar_to_screen(self.lidar_data, self.camera_image[:, 640:, :], ((-90,90,0), (-0.12, 0.52, 0.30), (-21.5, 28.0, 0)))

            # projected_points_left, _ = project_lidar_to_screen(self.lidar_data, self.camera_image[:, :640, :], ((-90,90,0), (0.12, 0.52, 0.30), (3  , -15.5, -2)))
            # projected_points_right, _ = project_lidar_to_screen(self.lidar_data, self.camera_image[:, 640:, :], ((-90,90,0), (-0.12, 0.52, 0.30), (0, 18, 0)))
