...
class gps_imu_fusion:
            ...
            if distance >= DIST:
                ...
                if self.b[RECORD_NUMBER - 1][0] != 0 or self.b[RECORD_NUMBER - 1][1] != 0:
                    ...
                    if (max_heading[3] - min_heading[3] < STRAIGHT_ANGLE*pi/180) and (max_heading[2] - min_heading[2] < STRAIGHT_ANGLE*pi/180) : 
                        ...
                        if (avg_heading[2] < avg_heading[3] - VAL_WEIGHT*var_heading[3]) :
                            heading_offset = (avg_heading[3] - VAL_WEIGHT*var_heading[3]) - avg_heading[2]  
                            # print("_______________________________________________________-BBBBBBBBBBBBBBBBB")


                        elif (avg_heading[2] > avg_heading[3] + VAL_WEIGHT*var_heading[3]) :
                            heading_offset = (avg_heading[3] + VAL_WEIGHT*var_heading[3]) - avg_heading[2] 
                            # print("_______________________________________________________-AAAAAAAAAAAAAAAAA")
    ...
    def get_heading(self, x, y, imu_orientation, gps, i,pos_flag):
        global heading_offset
        gps_heading = self.tf_heading_to_rad(gps)
        ...
        if self.straight_flag == False:
            self.heading_offset2 = round(heading_offset,3)

        # print("heading_offset",self.heading_offset2)
        heading = heading + self.heading_offset2
        # heading = self.update_KF(heading)

        if (abs(gps_heading - heading) > 0.2) and (abs(gps_heading - heading) < pi/4 and pos_flag == True and self.straight_flag == False):
            heading = gps_heading
...
#         elif self.straight_flag == True:
#             if self.init_count == 0:
#                 self.heading_straight = heading + self.heading_offset2    
#                 self.init_count += 1
#             else:
#                 heading = self.heading_straight
...
# #         # if (abs(gps_heading - heading) > 0.2) and (abs(gps_heading - heading) < pi/4 and pos_flag == True):
# #         #     heading = gps_heading
# #         #     print("_______________________________________________________-GPS_heading")
