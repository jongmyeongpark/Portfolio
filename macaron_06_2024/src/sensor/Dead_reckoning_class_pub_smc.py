    ...
    def Dead_reckoning(self,signal):
        ...
        ################################################################################################
            ...
            if self.Dead_reckoning_signal >=2:
                ...
                self.IMU_HEADING_CORRECTION = np.mean(self.HEADING_EDIT_MEAN) if self.HEADING_EDIT_MEAN != 0 else 0
            ...
            if self.Dead_reckoning_signal == 4:
                ...
                plt.plot(self.DEAD_RECKOING_count_plot[:], self.return_predict_Heading_array[:], label='predict_heading', color='magenta')
